...
class Grimpeur(commands2.SubsystemBase):
    def __init__(self) -> None:
        ...
        # Motors
        self.motor_grimpeur_primaire_follower = rev.CANSparkMax(ports.grimpeur_follower_motor_, rev.CANSparkMax.MotorType.kBrushless)
        self.motor_grimpeur_primaire = rev.CANSparkMax(ports.grimpeur_leader_motor_, rev.CANSparkMax.MotorType.kBrushless)
    ...
    def monter(self):
        self.motor_grimpeur_primaire.set(properties.grimpeur_vitesse_monter)

    def descend(self):
        self.motor_grimpeur_primaire.set(properties.vitesse_grimpeur_descend)

    def monter_secondaire(self):
        self.motor_grimpeur_secondaire.set(properties.grimpeur_vitesse_monter_secondaire)

    def descend_secondaire(self):
        self.motor_grimpeur_secondaire.set(properties.vitesse_grimpeur_descend_secondaire)
