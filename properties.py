...
class Properties:
    ...
    aide_pilotage_optimal_threshold = ntproperty("/Properties/aide_pilotage_optimal_threshold", 0.4, writeDefault=False, persistent=persistent)
    aide_pilotage_half_FOV = ntproperty("/Properties/aide_pilotage_half_FOV", 85, writeDefault=False, persistent=persistent)
    ...
    shooter_end_time = ntproperty("/Properties/shooter_end_time", 1, writeDefault=False, persistent=persistent)
    shooter_bas_speed = ntproperty("/Properties/shooter_bas_speed", 1500, writeDefault=False, persistent=persistent)
    shooter_bas_backspin_speed = ntproperty("/Properties/shooter_bas_backspin_speed", 1500, writeDefault=False, persistent=persistent)
    ...
    grimpeur_primaire_end_speed = ntproperty("/Properties/grimpeur_primaire_end_speed", 0.5, writeDefault=False, persistent=persistent)
    ...
    grimpeur_secondaire_vitesse_monter = ntproperty("/Properties/grimpeur_secondaire_vitesse_monter", 1, writeDefault=False, persistent=persistent)
    ...
    grimpeur_secondaire_end_speed = ntproperty("/Properties/grimpeur_secondaire_end_speed", 1, writeDefault=False, persistent=persistent)
    ...
    grimpeur_secondaire_hauteur_alignement_bas = ntproperty("/Properties/grimpeur_secondaire_hauteur_alignement_bas", 90, writeDefault=False, persistent=persistent)
    ...
    grimpeur_secondaire_current_limit = ntproperty("/Properties/grimpeur_secondaire_current_limit", 8, writeDefault=False, persistent=persistent)
    ...
    viser_hub_speed = ntproperty("/Properties/viser_hub_speed", 0.075, writeDefault=False, persistent=persistent)
    viser_hub_threshold = ntproperty("/Properties/viser_hub_threshold", 0.015, writeDefault=False, persistent=persistent)
