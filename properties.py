...
class Properties:
    ...
    shooter_backspin_speed = ntproperty("/Properties/shooter_backspin_speed", 100, writeDefault=False)
    shooter_speed = ntproperty("/Properties/shooter_speed", 100, writeDefault=False)

    shooter_ejecter_speed = ntproperty("/Properties/shooter_ejecter_speed", 2000, writeDefault=False)
    shooter_ejecter_backspin_speed = ntproperty("/Properties/shooter_ejecter_backspin_speed", 100, writeDefault=False)
    shooter_ejecter_temps = ntproperty("/Properties/shooter_ejecter_temps", 4, writeDefault=False)
